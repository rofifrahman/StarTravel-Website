  ...
  <body>
    ...
    <div class="container">
      <div class="row text-center" style="margin-top: 70px">
        ...
        >
          <div class="row">
            <p class="text-white fw-bold fs-3" style="padding-top: 70px">
              Login
            </p>
          </div>
          <form method="post" action="#">
            ...
            <label class="text-black fw-semibold fs-5 mt-2" for="password"
              >Password</label
            >
            <br />
            <input
            ...
            <a
              class="text-white"
              style="margin-left: 170px; font-size: 14px; text-decoration: none"
              href="#"
              >Forgot Password?</a
            >
            <br />
